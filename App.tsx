...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 selection:bg-red-500/30 selection:text-red-900 flex flex-col font-sans overflow-x-hidden justify-center items-center">
      ...
      <main className="w-full flex items-center justify-center p-2 sm:p-6 lg:p-8">
        <div className="w-full max-w-5xl bg-white border border-slate-200 rounded-2xl px-4 py-6 sm:p-10 shadow-xl relative overflow-hidden">
          ...
          {/* Section 1: Proposal Configuration */}
          <div className="relative z-10 mb-6 sm:mb-8">
            <h3 className="text-sm sm:text-base font-extrabold text-slate-800 uppercase tracking-widest mb-6 sm:mb-8 flex items-center gap-4">
               Proposal Configuration
               <span className="h-px bg-slate-200 flex-1"></span>
            </h3>
            
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-16 gap-y-8 sm:gap-y-12">
              ...
              <div className="space-y-8 sm:space-y-12 flex flex-col justify-start">
                 <Slider
                  label="Hourly Rate"
          ...
          <div className="relative z-10 pt-6 sm:pt-8 border-t border-slate-100">
            <h3 className="text-sm sm:text-base font-extrabold text-slate-800 uppercase tracking-widest mb-4 sm:mb-6 flex items-center gap-4">

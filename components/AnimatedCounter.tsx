...
export const AnimatedCounter: React.FC<AnimatedCounterProps> = ({ 
  ...
  return (
    <div className={`p-2 sm:p-5 rounded-xl border flex flex-col justify-center h-full transition-colors duration-300 ${
      highlight 
        ? 'bg-red-50 border-red-100 shadow-[0_2px_10px_rgba(220,38,38,0.05)]' 
        : 'bg-white border-slate-200 shadow-sm'
    }`}>
      <div className="text-[10px] sm:text-xs text-slate-500 font-bold uppercase tracking-wider mb-1 sm:mb-2 truncate">
        {label}
      </div>
